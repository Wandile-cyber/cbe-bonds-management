<div>
    ...
    <div class="fixed text-left top-0 left-0 z-50 transition-all duration-500 fc-modal hidden w-full h-full min-h-full items-center fc-modal-open:flex">
        <div class="fc-modal-open:opacity-100 duration-500 opacity-0 ease-out transition-[opacity] sm:max-w-lg sm:w-full sm:mx-auto  flex-col bg-white border shadow-sm rounded-md dark:bg-slate-800 dark:border-gray-700">
            ...
            <div class="flex justify-end items-center gap-4 p-4 border-t dark:border-slate-700">
                ...
                <button wire:click="updateAccount" class="py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded bg-primary hover:bg-primary-600 text-white" data-fc-dismiss href="javascript:void(0)">Updated</button>
                <button wire:click="removeAccount" class="py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded bg-danger hover:bg-danger-600 text-white" data-fc-dismiss href="javascript:void(0)">Remove</button>
            </div>
        </div>
    </div>
</div>
